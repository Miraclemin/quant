...
from quant_infra.get_data import get_trade, get_stock_data_by_date, get_daily_basic
...
# %%
    ...
    # # #因子评测（月度调仓，使用DuckDB）
    # print("\n因子评测...")
    # evaluate_factor(factor_table='week_factor', fac_freq='周度', bench_index='000002.SH')

if __name__ == '__main__':
    main()
    # group_plot('全市场', '周度', 'short', 'week_factor')
